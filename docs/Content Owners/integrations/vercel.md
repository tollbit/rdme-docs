...
To redirect bots to your `tollbit` subdomain you can use <Anchor target="_blank" href="https://vercel.com/docs/security/vercel-waf/custom-rules">Vercel's Custom WAF rules</Anchor>.
