...
Enabling logs with Imperva requires dropping traffic logs to an S3 or GCS bucket, adding in the appropriate permissions on the bucket, and then sending your bucket details to team@tollbit.com for completing the ingestion.

See the Imperva docs [here](https://docs-cybersec.thalesgroup.com/bundle/cloud-application-security/page/settings/log-integration.htm) for reference on how to enable log ingestion from the Imperva portal.

Step 1 - Go to account management on the top right corner of the Imperva portal

![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-1-logs.png)
...
![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-2-logs.png)
...
![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-4-logs.png)
...
![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-5-logs.png)
...
Enabling the TollBit bot paywall can be set up with Imperva’s Security Rules tooling. Please see docs [here](https://docs-cybersec.thalesgroup.com/bundle/cloud-application-security/page/rules/rule-parameters.htm) for reference.

Step 1 - On the Imperva home page, select the Site you’re looking to set up the Paywall for.

![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-1-paywall.png)
...
![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-2-paywall.png)
...
![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-3-paywall.png)
...
![](https://raw.githubusercontent.com/tollbit/rdme-docs/v1.0/rdme-docs/public/integrations-imperva-4-paywall.png)
