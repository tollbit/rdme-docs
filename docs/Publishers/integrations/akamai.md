...
[Akamai Control Center](https://control.akamai.com/apps/data-stream-ui/#/streams/group/all).
Follow
[these instructions](https://techdocs.akamai.com/datastream2/docs/create-stream)
on how to create your stream.

### Choose Data Parameters

When choosing
[data parameters](https://techdocs.akamai.com/datastream2/docs/choose-data-parameters),
...
[here](https://techdocs.akamai.com/datastream2/docs/stream-custom-https). The
...
the value as your secret key from your [dashboard](https://app.tollbit.com).

Finally, you can
[review and activate](https://techdocs.akamai.com/datastream2/docs/review-activate-stream)
your stream!

### Akamai Bot Paywall

Akamai allows you to set up redirection rules at the edge using Cloudlets. Specifically, they provide [Edge Redirector](https://techdocs.akamai.com/cloudlets/docs/what-edge-redirector) Cloudlets that help you manage redirection using certain matching rules.

We want to first start by creating an Edge Redirector policy. Follow the documentation [here](https://techdocs.akamai.com/cloudlets/docs/create-edge-redirector-policy) to do so in accordance with how your Akamai instance is set up.

Once you have set up your policy, follow the documentation [here](https://techdocs.akamai.com/cloudlets/docs/add-edge-redirector-rules) to set up rules for your Edge Redirector. Because we want to be redirecting based on the `User-Agent` header, we will need to create a redirector with advance matching rules. You will want to create a match type based on the [request header](https://techdocs.akamai.com/cloudlets/docs/req-header). The name of the header should be `User-Agent`, and the value should be a tab separated list of bad user agents. You can use the following list:
